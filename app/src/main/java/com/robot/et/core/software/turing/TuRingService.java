...
public class TuRingService extends Service implements TuringUnderstanderImpl {
	...
	public void onCreate() {
		...
		SpeechImplHandle.setTuringUnderstander(this);
				...
				try {
					...
					if (result_obj.has("text")) {
						...
						if (!TextUtils.isEmpty(content)) {
							...
							SpeechImplHandle.startSpeak(DataConfig.SPEAK_TYPE_CHAT, content);
						} else {
